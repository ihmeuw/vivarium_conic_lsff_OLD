...
``src/vivarium_conic_lsff/model_specifications``.
...
def make_specs(template: str, locations_file: str, single_location: str, output_dir: str) -> None:
    ...
    ``vivarium_conic_lsff/src/vivarium_conic_lsff/model_specification/model_spec.in``
    ...
    ``vivarium_conic_lsff/src/vivarium_conic_lsff/model_specification/locations.txt``
